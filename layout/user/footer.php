        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item d-flex flex-column">
                    ...
                    <p>This System aims to provide a robust platform for evaluating and certifying Japanese language proficiency across various levels.
                    </p>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="<?php echo $user_base_url. "home.php#questions" ?>"><i class="fa fa-angle-right me-2"></i>
                        Questions</a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href=""><i class="fa fa-map-marker me-2"></i> University Of Computer Studies, Pyay</a>
                    <a href=""><i class="fa fa-envelope me-2"></i> YeeMonKyaw@example.com</a>
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-md-6 text-center text-md-start mb-md-0">
                <span class="text-white"><a href="#"><i class="fa fa-copyright text-light me-2"></i>Japanese Language
                        Test System</a>,
            ...
            <div class="col-md-6 text-center text-md-end text-white">
                ...
                Designed By <a class="border-bottom" href="#">YMK</a> Distributed By <a class="border-bottom"
                    href="#">YMK</a>
            </div>
        </div>
    </div>
