    ...
    <div class="header-carousel-item">
        ...
        <div class="carousel-caption">
            <div class="carousel-caption-content p-3">
                ...
                <a class="btn btn-primary rounded-pill text-white py-3 px-5" href=<?php echo $user_base_url. "home.php#questions" ?>>Try Sample Questions</a>
            </div>
        </div>
    </div>
    <div class="header-carousel-item">
        ...
        <div class="carousel-caption">
            <div class="carousel-caption-content p-3">
                ...
                <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="<?php $user_base_url ."home.php"?>">Try Sample Questions</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="container py-5">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                        <a href="<?php echo $user_base_url . "type.php?level_id=" .$level['level_id'] ?>" class="service-item rounded">
