            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="post">
                ...
                <div class="form-group">
                  <label>Email</label>
                  <input type="text" class="form-control _input" name="email" id="name"
                    value="<?php echo htmlspecialchars($email); ?>">
                  <p style="color:red"><?= $email_err ?></p>
                </div>
                <div class="form-group">
                  <label>Password</label>
                  <input type="password" class="form-control _input" name="password" id="pwd">
